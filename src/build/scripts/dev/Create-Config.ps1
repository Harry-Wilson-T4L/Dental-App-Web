...
Process
{
    ...
    $NewArgsString = $NewArgsString + " -skip:skipaction='Delete',objectname='dirPath',absolutepath=""^[^\\]*\\emails($|\\.*)"""
    $NewArgsString = $NewArgsString + " -skip:skipaction='Delete',objectname='filePath',absolutepath=""^[^\\]*\\emails\\.*"""
...
"{
    ""ConnectionStrings"": {
        ""DefaultConnection"": ""Server=.\\SQLEXPRESS;Database=DentalDrill.CRM.Dev;Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=true""
    },
    ""Application"": {
        ""BaseUrl"": ""https://dev.hub.dentaldrillsolutions.com.au/""
    },
    ""PickupRequest"": {
        ""Email"": {
            ""Enabled"": true,
    ...
    ""HandpieceStoreOrders"": {
        ""Email"": {
            ""Enabled"": true,
            ""Recipient"": ""mneveroff@devguild.ru"",
            ""BaseUrl"": ""https://dev.hub.dentaldrillsolutions.com.au/"",
            ""SubjectPrefix"": ""[TEST] ""
        }
    },
