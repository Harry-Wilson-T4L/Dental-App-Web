...
{
    public class InventoryMovementCreateModel
    {
        [BindNever]
        public InventoryMovementStatus[] AvailableStatuses { get; } = { InventoryMovementStatus.Completed, };
