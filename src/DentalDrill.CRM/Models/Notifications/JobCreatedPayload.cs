...
{
    [NotificationPayload(NotificationType.JobCreated)]
    public class JobCreatedPayload : NotificationPayload
    {
        public JobCreatedPayload()
        {
        }

        public JobCreatedPayload(Job job)
        {
            this.JobId = job.Id;
