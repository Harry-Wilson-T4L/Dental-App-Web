...
(function (DentalDrill) {
    ...
    (function (CRM) {
        ...
        (function (Controls) {
            var Reporting;
            (function (Reporting) {
                var ReportsPageTabDateRangeBase = /** @class */ (function (_super) {
                    __extends(ReportsPageTabDateRangeBase, _super);
                    function ReportsPageTabDateRangeBase() {
                        return _super !== null && _super.apply(this, arguments) || this;
                    }
                    ReportsPageTabDateRangeBase.prototype.generateDateRange = function (from, to, type) {
                    ...
                    return ReportsPageTabDateRangeBase;
                }(Reporting.ReportsPageTabBase));
                Reporting.ReportsPageTabDateRangeBase = ReportsPageTabDateRangeBase;
            })(Reporting = Controls.Reporting || (Controls.Reporting = {}));
        })(Controls = CRM.Controls || (CRM.Controls = {}));
    })(CRM = DentalDrill.CRM || (DentalDrill.CRM = {}));
})(DentalDrill || (DentalDrill = {}));
//# sourceMappingURL=ReportsPageTabDateRangeBase.js.map