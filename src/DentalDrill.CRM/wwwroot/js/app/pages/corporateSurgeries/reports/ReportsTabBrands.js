            ...
            (function (CorporateSurgeries) {
                ...
                (function (Reports) {
                    ...
                    var ReportsTabBrands = /** @class */ (function (_super) {
                                ...
                                return __generator(this, function (_e) {
                                    ...
                                    if (detailRows.length > 0) {
                                        ...
                                        if (index === 1) {
                                            ...
                                            dataSet = this._dataSource.data().map(function (x) { return x; });
                                            surgeries = this._dataSourceSurgeries.data().map(function (x) { return x; });
                                            table.columns[0].setFormatter(function (item) {
                                                if (item.ClientName) {
                                            ...
                                            table.setData(dataSet.concat(surgeries), function (left, right) {
                                                if (left.Brand < right.Brand)
                                                    return -1;
                                                if (left.Brand > right.Brand)
                                                    return 1;
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            ...
                                            return [4 /*yield*/, this._dataSourceSurgeries.read()];
                                        case 3:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                        ...
                        ReportsTabBrands.prototype.createMainGrid = function () {
                            ...
                            wrapper.kendoGrid({
                                ...
                                detailInit: function (e) {
                                    ...
                                    var surgeriesGridHost = e.detailCell.find(".reports__brands__item__details__surgeries-grid");
                                    var modelsGridHost = e.detailCell.find(".reports__brands__item__details__models-grid");
                                    var brand = e.data["Brand"];
                                    _this.createSurgeriesGrid(surgeriesGridHost, brand);
                                    _this.createModelsGrid(modelsGridHost, brand);
                                }
                            });
                            this._mainGrid = wrapper.data("kendoGrid");
                        };
                        ReportsTabBrands.prototype.createSurgeriesGrid = function (host, brand) {
                            var subset = [];
                            var superset = this._dataSourceSurgeries.data();
                            ...
                            var surgeriesDataSource = new kendo.data.DataSource({
                                data: subset,
                                schema: {
                                    model: {
                                        fields: this.initializeDataSourceFields({
                        ...
                        ReportsTabBrands.prototype.applyGlobalFilters = function (from, to, clients) {
                            return __awaiter(this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
