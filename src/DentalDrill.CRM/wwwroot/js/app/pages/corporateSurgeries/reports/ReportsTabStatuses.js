            ...
            (function (CorporateSurgeries) {
                ...
                (function (Reports) {
                    ...
                    var ReportsTabStatuses = /** @class */ (function (_super) {
                        ...
                        ReportsTabStatuses.prototype.exportPdf = function () {
                            return __awaiter(this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    ...
                                    table.rowHeight = 23;
                                    table.addColumn("Surgery", 200, function (x) { return x.ClientName; });
                        ...
                        ReportsTabStatuses.prototype.applyGlobalFilters = function (from, to, clients) {
                            return __awaiter(this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                        ...
                        ReportsTabStatuses.prototype.toggleInsights = function () {
                            return __awaiter(this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    ...
                                    this._insightsContainer.append($("<div></div>").addClass("row").append($("<div></div>").addClass("col-12 reports__insights__total__caption text-center font-italic mt-2").text("Total Handpieces by statuses")));
                                    this._insightsContainer.append(charts.container);
                                    this._insightsContainer.append(totalsAvg.container);
                                    this._insightsContainer.append($("<div></div>").addClass("row").append($("<div></div>").addClass("col-12 reports__insights__total__caption text-center font-italic mt-2").text("Average Handpieces by statuses")));
                                    sumChartData = [
