namespace DentalDrill.CRM.Pages.CorporateSurgeries.Index {
    ...
    export class StatusRepairsGridFilterFieldsCollection extends DevGuild.Filters.Grids.GridFilterFieldsCollection {
        ...
        constructor(root: JQuery) {
            ...
            this._client = new DevGuild.Filters.Grids.DropDownListGridFilterField($("#ClientFilter"), "ClientId", { value: a => a.Value, defaultValue: "" });
    ...
    export class RepairsGridFilter extends DevGuild.Filters.Grids.GridFilterCore<StatusRepairsGridFilterFieldsCollection> {
        private readonly _page: CorporatePage;

        constructor(page: CorporatePage) {
            super(page.root);
            this._page = page;
        }
  ...
  <div class="handpiece-status-indicator__points">
    ...
    export class CorporatePage {
        ...
        private readonly _statusGrid: CorporateStatusGrid;
    ...
    $(() => {
        const page = new CorporatePage($(".surgery-page"));
        page.initialize();
    });
    ...
    export class StatusRepairsGrid {
        static handleDetailsClick(client: string, id: string) {
            ...
            const url = routes.corporateSurgeries.handpiece(client, id);
            const options = {
    ...
    $(() => {
        $(document as any).on("click", ".surgery__repair", (e: JQueryEventObject) => {
            ...
            const corporateId = target.getAttribute("data-corporate-id");
