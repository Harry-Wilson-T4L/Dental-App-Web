    ...
    (function (CRM) {
        ...
        (function (Pages) {
            ...
            (function (CorporateSurgeries) {
                ...
                (function (Index) {
                    ...
                    var StatusRepairsGridFilterFieldsCollection = /** @class */ (function (_super) {
                        ...
                        function StatusRepairsGridFilterFieldsCollection(root) {
                            ...
                            _this._client = new DevGuild.Filters.Grids.DropDownListGridFilterField($("#ClientFilter"), "ClientId", { value: function (a) { return a.Value; }, defaultValue: "" });
                    ...
                    var RepairsGridFilter = /** @class */ (function (_super) {
                        ...
                        RepairsGridFilter.prototype.applyFilter = function (filters) {
                            ...
                            MaintenanceHandpiecesListView.setFiltersData({
                                ClientId: $("#ClientFilter").data("kendoDropDownList").value(),
                    ...
                    var CorporateStatusGrid = /** @class */ (function () {
                        function CorporateStatusGrid(page, host) {
                            this._page = page;
                            this._host = host;
                            this._dataSource = this.createDataSource();
                            this._grid = this.createGrid();
                        }
                        CorporateStatusGrid.prototype.setTotal = function (status, value) {
                            var nodes = this._host.find(".surgery-status-grid__status-counter[data-status=" + status + "]");
                            nodes.text(value.toString());
                        };
                        CorporateStatusGrid.prototype.expandPresent = function () {
                            var _this = this;
                        ...
                        CorporateStatusGrid.prototype.createDataSource = function () {
                        ...
                        CorporateStatusGrid.prototype.createGrid = function () {
                            var _this = this;
                        ...
                        return CorporateStatusGrid;
                    }());
                    Index.CorporateStatusGrid = CorporateStatusGrid;
                    var CorporatePage = /** @class */ (function () {
                        function CorporatePage(root) {
                            var _this = this;
                            ...
                            this._statusGrid = new CorporateStatusGrid(this, this._root.find(".surgery-page__status-grid"));
                            this._root.data("CorporatePage", this);
                        }
                        Object.defineProperty(CorporatePage.prototype, "root", {
                            get: function () {
                                return this._root;
                            },
                            enumerable: false,
                        ...
                        CorporatePage.prototype.initialize = function () {
                        ...
                        CorporatePage.prototype.updateDataSource = function (filters) {
                            return __awaiter(this, void 0, void 0, function () {
                        ...
                        CorporatePage.prototype.getStatusDataSource = function (status) {
                            return this._statusSourceMap.get(status);
                        };
                        CorporatePage.prototype.setStatusData = function (status, data) {
                        ...
                        CorporatePage.prototype.createDataSource = function () {
                            return new kendo.data.DataSource({
                                type: "aspnetmvc-ajax",
                                transport: {
                                    read: {
                                        url: "/CorporateSurgeries/" + this._path + "/Handpieces"
                                    }
                                },
                                serverPaging: true,
                                serverSorting: true,
                    ...
                    Index.CorporatePage = CorporatePage;
                    $(function () {
                        var page = new CorporatePage($(".surgery-page"));
                        page.initialize();
                    });
                    var StatusRepairsGrid = /** @class */ (function () {
                        ...
                        StatusRepairsGrid.handleDetailsClick = function (client, id) {
                            var url = routes.corporateSurgeries.handpiece(client, id);
                            var options = {
                    ...
                    $(function () {
                        $(document).on("click", ".surgery__repair", function (e) {
                            ...
                            var corporateId = target.getAttribute("data-corporate-id");
                            var id = target.getAttribute("data-id");
                            if (corporateId && id) {
                                StatusRepairsGrid.handleDetailsClick(corporateId, id);
                            }
                        });
                    });
                        ...
                        MaintenanceHistory.loadHistory = function (handpiece) {
                            return __awaiter(this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    ...
                                    MaintenanceHistory.container.insertAfter(targetRowLastElement);
                                    return [2 /*return*/];
                                });
                            });
                        };
                    ...
                    var HandpieceImagesCarousel = /** @class */ (function () {
                        function HandpieceImagesCarousel(surgery, id, firstImage) {
                            ...
                            this._windowWrapper.kendoWindow({
                                ...
                                modal: true,
                                visible: false,
                                content: "/CorporateSurgeries/" + this._surgery + "/Handpiece/" + id + "/Images" + (firstImage ? "?image=" + firstImage : ""),
                                refresh: function (e) {
                                    e.sender.center();
                                }
                            });
                ...
                })(Index = CorporateSurgeries.Index || (CorporateSurgeries.Index = {}));
