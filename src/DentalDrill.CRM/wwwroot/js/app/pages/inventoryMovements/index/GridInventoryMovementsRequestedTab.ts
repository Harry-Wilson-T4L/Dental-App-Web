namespace DentalDrill.CRM.Pages.InventoryMovements.Index {
    ...
    export class GridInventoryMovementsRequestedTab extends GridInventoryMovementsTabBase {
        ...
        protected initializeCommands(): kendo.ui.GridColumnCommandItem[] {
            ...
            commands.push({
                ...
                click: GridHandlers.createButtonClickPopupHandler<InventoryMovementReadModel>(
                    item => new DevGuild.AspNet.Routing.Uri(`/InventoryMovements/Approve/${item.Id}`),
                    item => ({
                        ...
                        open: async (e: kendo.ui.WindowEvent) => {
                            await AjaxFormsManager.waitFor("InventoryMovementsApprove");
            ...
            commands.push({
                ...
                click: GridHandlers.createButtonClickPopupHandler<InventoryMovementReadModel>(
                    item => new DevGuild.AspNet.Routing.Uri(`/InventoryMovements/ApproveWithEdit/${item.Id}`),
                    item => ({
                        title: `Approve Movement`,
                        width: `800px`,
                        height: `auto`,
                        ...
                        open: async (e: kendo.ui.WindowEvent) => {
                            await AjaxFormsManager.waitFor("InventoryMovementsApproveWithEdit");
                            await this.grid.dataSource.read();
                            e.sender.close();
                            e.sender.destroy();
                        },
