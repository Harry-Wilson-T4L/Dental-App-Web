        ...
        (function (Pages) {
            ...
            (function (GlobalReports) {
                ...
                (function (Reports) {
                    ...
                    var ReportsTabGeneralStats = /** @class */ (function (_super) {
                        __extends(ReportsTabGeneralStats, _super);
                        function ReportsTabGeneralStats() {
                            return _super !== null && _super.apply(this, arguments) || this;
                        }
                        ReportsTabGeneralStats.prototype.initializeInsights = function () {
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [4 /*yield*/, this.insightsContainer.addChartsAsync(function (charts) { return __awaiter(_this, void 0, void 0, function () {
                                                    var statusDataSource, brandsDataSource, collection, collection;
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0: return [4 /*yield*/, this.createDataSource({ transport: { read: { data: { DateAggregate: "EntirePeriod", Fields: ["HandpieceStatus"] } } } })];
                                                            case 1:
                                                                statusDataSource = _a.sent();
                                                                return [4 /*yield*/, this.createDataSource({ transport: { read: { data: { DateAggregate: "EntirePeriod", Fields: ["Brand"] } } } })];
                                                            case 2:
                                                                brandsDataSource = _a.sent();
                                                                {
                                                                    collection = new Collection(statusDataSource.data().map(function (x) { return x; }));
                                                                    charts.createPieChart()
                                                                        .override(function (options) {
                                                                        options.seriesDefaults.labels.visible = false;
                                                                        options.tooltip.template = "#: category #: #: value #";
                                                                    })
                                                                        .initialize("Status", collection.groupBy(function (x) {
                                                                        switch (x.HandpieceStatus) {
                                                                            case 60: return "Sent Complete";
                                                                            case 71: return "Unrepairable";
                                                                            case 70: return "Cancelled";
                                                                            case 51: return "Return Unrepaired";
                                                                            default: return "Other";
                                                                        }
                                                                    }).select(function (x) { return ({ category: x.key, value: x.items.count() }); }).toArray(), "{0:n0}", "#: category #: \n #: value #", undefined);
                                                                }
                                                                {
                                                                    collection = new Collection(brandsDataSource.data().map(function (x) { return x; }));
                                                                    charts.createPieChart()
                                                                        .override(function (options) {
                                                                        options.seriesDefaults.labels.visible = false;
                                                                        options.tooltip.template = "#: category #: #: value #";
                                                                    })
                                                                        .initialize("Brands", collection.groupBy(function (x) { return x.Brand; }).select(function (x) { return ({ category: x.key, value: x.items.count() }); }).toArray(), "{0:n0}", "#: category #: \n #: value #", undefined);
                                                                }
                                                                return [2 /*return*/];
                                                        }
                                                    });
                        ...
                        ReportsTabGeneralStats.prototype.initializeDataSourceTransportRead = function () {
                            return __awaiter(this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    return [2 /*return*/, {
                        ...
                        ReportsTabGeneralStats.prototype.initializeDataSourceValueFields = function () {
                            return [
                                "HandpiecesCount",
                                "UnrepairedPercent",
                        ...
                        ReportsTabGeneralStats.prototype.initializeDataSourceGroupFields = function () {
                            return {
                                Brand: { type: "string" },
                                Model: { type: "string" },
                            };
                        };
                        ReportsTabGeneralStats.prototype.initializeGridValueColumns = function () {
                            return [
                        ...
                        ReportsTabGeneralStats.prototype.initializeGridGroupColumns = function () {
                            var columnsConfig = [];
                            columnsConfig.push({
                                field: "Brand",
                                title: "Brand",
                        ...
                        ReportsTabGeneralStats.prototype.alterDataSourceOptions = function (dataSourceOptions) {
                            dataSourceOptions.group = [
                                { field: "Brand" }
                            ];
                        };
                        ReportsTabGeneralStats.prototype.alterGridOptions = function (gridOptions) {
