...
{
    public partial class AlterInventoryMovementLinkedHandpiecesViewToIncludeClientInfo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"create or alter view [InventoryMovementLinkedHandpieces] (
  [Id], [JobId], [JobNumber], [JobStatus], [HandpieceId], [HandpieceNumber], [HandpieceStatus], [HandpiecePartsComment], [ClientId], [ClientFullName]
) as
select distinct 
  im.[Id],
  j.[Id] as [JobId],
...
left join [Jobs] j on j.[Id] = h.[JobId]
left join [Clients] c on c.[Id] = j.[ClientId]", suppressTransaction: true);
